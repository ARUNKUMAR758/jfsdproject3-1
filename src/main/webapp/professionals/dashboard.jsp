...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="/professionals/services/add" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
            ...
            <a href="/professionals/profile" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
