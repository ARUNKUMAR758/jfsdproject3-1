...
<html>
<head>
    <title>User Dashboard - ProServices</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="/search" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                <h3 class="text-lg font-semibold mb-2">Find Services</h3>
                <p class="text-gray-600">Search for professional services</p>
            </a>
            <a href="/users/users" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                <h3 class="text-lg font-semibold mb-2">My Bookings</h3>
                <p class="text-gray-600">View and manage your bookings</p>
            </a>
            <a href="/users/profile" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
