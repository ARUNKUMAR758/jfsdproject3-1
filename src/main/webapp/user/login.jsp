        ...
        <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="/users/register" class="font-medium text-blue-600 hover:text-blue-500">
            ...
            <form class="mt-8 space-y-6" action="/users/login" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="/users/forgot-password" class="font-medium text-blue-600 hover:text-blue-500">
